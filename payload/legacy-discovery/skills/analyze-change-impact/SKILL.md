...
Depois de persistir o `IMPACT`, não gere estratégia de mitigação ou plano técnico. Se o usuário pretende alterar o sistema, a próxima etapa é `prepare-speckit-context`, que consumirá este raio de impacto no `SPECKIT_HANDOFF`.
