...
## Saída Obrigatória
- Status e revisão do refinamento (`AWAITING_HUMAN`, `READY_FOR_REVIEW` ou `BLOCKED`).
...
- Sem pergunta bloqueante aberta, grave `READY_FOR_REVIEW`. Nunca `READY_FOR_SPECKIT`: isso é a aprovação humana.
