...
5. Depois da correção, um teste verde comprova o critério de aceite. A regressão completa da solution pertence à skill `run-solution-regression`; a consolidação final das evidências pertence à `coordinate-fix`.
